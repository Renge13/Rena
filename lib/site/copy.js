...
export const COMPAT_COPY = {
   ...
   * UNRULED. Reyner's. `scripts/check-unruled-copy.mjs` refuses a production
   * build while this carries the sentinel; preview and local builds pass so the
   * string can be seen in context before it is ruled.
   */
  invoiceDesc: PENDING('compat_invoice_desc'),
};
